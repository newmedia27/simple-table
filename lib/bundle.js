...
import { RichUtils, EditorState, genKey, Modifier, ContentBlock, ContentState, SelectionState, Editor as Editor$1, convertToRaw, DefaultDraftInlineStyle, getDefaultKeyBinding, KeyBindingUtil } from 'draft-js';
...
var ModalCtx = /*#__PURE__*/createContext();
var initialModal = {
  isOpen: false,
  defaultSchema: null,
  editorState: null,
...
function App(_ref) {
  ...
  var _useState = useState(initialModal),
      modal = _useState[0],
  ...
  return /*#__PURE__*/jsxs(ModalCtx.Provider, {
    ...
    children: [children, /*#__PURE__*/jsx(Modal, {
      ...
      children: function children(close) {
        return /*#__PURE__*/jsx(ModalTable, {
          closeModal: close
        });
      }
    })]
...
export { Button, TablePlugin, App as Wrapper };
